...
struct GlassmorphismConfiguration {
    ...
    static var standard: GlassmorphismConfiguration {
        GlassmorphismConfiguration(
            ...
            borderWidth: 1.0,
            tintedBackgroundColor: AppColor.Glassmorphism.tintColor.withAlphaComponent(0.07),
            blurIntensity: 0.2,
            theme: .light,
    ...
    static var notification: GlassmorphismConfiguration {
        GlassmorphismConfiguration(
            ...
            borderWidth: 1.0,
            tintedBackgroundColor: AppColor.Glassmorphism.tintColor.withAlphaComponent(0.25),
            blurIntensity: 0.2,
            theme: .light,
            outerShadowColor: AppColor.Glassmorphism.outerShadowColor,
