...
//	private let interactor: CourtListInteractor
	...
	private var courtList: [(court: Court, distance: Double)] = [] {
		didSet {
			updateFilteredCourts()
		}
	}

	private var filteredCourts: [(court: Court, distance: Double)] = []

	private var selectedCourt: Court?
	private var initialCourts: [Court] = []
...
//	init(/*courts: [Court], selected: Court?*/) {
